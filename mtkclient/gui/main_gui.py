...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 605, 278))
        ...
        self.loadtab.setObjectName(u"loadtab")
        self.loadpartitionList = QScrollArea(self.loadtab)
        self.loadpartitionList.setObjectName(u"loadpartitionList")
        self.loadpartitionList.setGeometry(QRect(9, 69, 607, 280))
        sizePolicy7.setHeightForWidth(self.loadpartitionList.sizePolicy().hasHeightForWidth())
        self.loadpartitionList.setSizePolicy(sizePolicy7)
        self.loadpartitionList.setMinimumSize(QSize(0, 280))
        self.loadpartitionList.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self.loadpartitionList.setHorizontalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self.loadpartitionList.setSizeAdjustPolicy(QAbstractScrollArea.AdjustToContentsOnFirstShow)
        self.loadpartitionList.setWidgetResizable(True)
        self.scrollAreaWidgetContents_load = QWidget()
        self.scrollAreaWidgetContents_load.setObjectName(u"scrollAreaWidgetContents_load")
        self.scrollAreaWidgetContents_load.setGeometry(QRect(0, 0, 605, 278))
        self.loadpartitionList.setWidget(self.scrollAreaWidgetContents_load)
        self.loadtitle = QLabel(self.loadtab)
        self.loadtitle.setObjectName(u"loadtitle")
        self.loadtitle.setGeometry(QRect(9, 11, 607, 20))
        sizePolicy1.setHeightForWidth(self.loadtitle.sizePolicy().hasHeightForWidth())
        self.loadtitle.setSizePolicy(sizePolicy1)
        self.loadtitle.setMinimumSize(QSize(0, 20))
        self.loadtitle.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        self.loadbackbutton = QPushButton(self.loadtab)
        self.loadbackbutton.setObjectName(u"loadbackbutton")
        self.loadbackbutton.setGeometry(QRect(9, 40, 122, 25))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 574, 296))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 602, 278))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.loadtitle.setText(QCoreApplication.translate("MainWindow", u"Select partitions to load", None))
        self.loadbackbutton.setText(QCoreApplication.translate("MainWindow", u"Go back", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.loadtab), QCoreApplication.translate("MainWindow", u"Load partition(s)", None))
