...
class Volume:
    ...
    def __init__ (self, da_handler, ignore_flags = False, ignore_magic = False):
        """
        ...
        # e.g. self.superblock["system"] = superblock
        self.superblock = None
        self.superblockList = {}
        self.group_descriptors = None
        self.group_descriptorsList = {}
        # e.g. self.preInodeMap["system"][cur_inode]=pre_inode
        self.preInodeMap = {}
    ...
    def get_pre_inode(self):
        return self.preInodeMap[self.partition][self.cur_inode]
    ...
    def get_inode (self, inode_idx):
        ...
        """
        #print("get_inodeXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
        ...
        inode = Inode(self, inode_offset, inode_idx)
        return inode
    ...
    def read_struct (self, structure, offset, platform64 = None):
        ...
        """
        variables = mock.Mock()
        variables.partitionname = self.partition
        variables.filename = ''
        variables.parttype = None
        variables.offset = offset
        variables.length = ctypes.sizeof(structure)
    ...
    def read_struct_tmp (self, structure, raw, platform64 = None):
        """
        Interprets the bytes at offset as structure and returns the interpreted instance
        """
    ...
    def root(self):
        ...
        """
        #print("rootXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
        node = self.get_inode(Volume.ROOT_INODE)
        return node
...
class Inode:
    ...
    def __init__ (self, volume, offset, inode_idx):
        ...
        # variables = mock.Mock()
        # variables.partitionname = "system"
        # # variables.filename = os.path.join(self.dumpFolder, partition + ".bin")
        # variables.filename = ""
        # variables.parttype = None
        # variables.offset = offset
        # variables.length = ctypes.sizeof(ext4_inode)
        # raw = volume.da_handler.handle_da_cmds(volume.mtkClass, "rm", variables)
        # self.inode = volume.read_struct(ext4_inode, raw)
...
class BlockReader:
    ...
    def read_block (self, file_block_idx):
        ...
        if disk_block_idx != None:
            variables = mock.Mock()
            variables.partitionname = self.volume.partition
            variables.filename = ""
            variables.parttype = None
            variables.offset = disk_block_idx * self.volume.block_size
            variables.length = self.volume.block_size
            raw = self.volume.da_handler.handle_da_cmds(self.volume.mtkClass, "rm", variables)
            return raw
        else:
